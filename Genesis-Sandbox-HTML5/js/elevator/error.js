...
(function($) {
    ...
    $(window).load(function() {
        ...
        */
        ...
        $(document).on("change", "#input_1_13, #input_1_26", function(e) {

            initCheckAll($('#input_1_51'));
        ...
        $(document).on("click", '#menu-item-1690 a, #menu-item-1691 a, #menu-item-1692 a, #menu-item-1693 a, #menu-item-1694 a', function() {
    ...
    function checkLimitInit(input, requiredInput) {
        ...
        if (input !== null) {
            ...
            if (val > max) {
                if ($(input).is('#input_1_51')) {

                    name = 'Combined Width';
                    var pocket = parseFloat($('#input_1_26').val());

                    if (pocket !== 0) {

                        $('#input_1_13, #input_1_26').addClass('error');
    ...
    function enableTotal() {
        ...
        if (errors.length === 0) {
            ...
            if ($('.total-error').length < 1) {
                $('#text-2 .textwidget').after('<div class="total-error">N/A</div>');
            }
        }
    }
