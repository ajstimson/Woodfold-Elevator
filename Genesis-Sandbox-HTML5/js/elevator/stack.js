(function($) {
    ...
    $(window).load(function() {
        ...
        */
        ...
        $(document).on("click change touchend keyup", "#input_1_13, #input_1_26, #stack-items-right input", function(e) {
        ...
        $(document).on("change", "#field_1_46 input, #input_1_13, #input_1_26", function() {
            //override jamb hold class and change jamb forward/away status
            toggleJambState();

        });

        $(document).on("change", "#field_1_46 input", function() {
        ...
        $(document).on('click change keyup', '#input_1_13, #input_1_26', function() {
            //console.log('click change keyup #input_1_13 #input_1_26... widthPocketSum(a) & setJambState');
            var a = $(this);
            widthPocketSum(a);
            setJambState();
        });
    ...
    function setNumGates() {
        var target = $('#dim-3 span'),
            ...
            base = 4,
            open = $('#input_1_51').val(),
            dubGate = $('#input_1_46 input:checked').val(),
            jamb = $('#input_1_48 input:checked').val();
    ...
    function calculateGates(open, base, dubGate, jamb) {
        ...
        if (dubGate === 'Yes') {
            ...
            if ($('#field_1_48 input').hasClass('jamb-hold')) {
    ...
    function setStackCollapse() {
        var target = $('#stackCollapsedSize'),
            num = 6.4375,
            gates = $('#input_1_50').val(),
            pocket = $('#input_1_26').val(),
            dubg = $('#input_1_46 input:checked').val();
    ...
    function stackImgInit() {
        var panelImgSection = $('#field_1_43'),
            collapseImgSection = $('#field_1_44');
    ...
    function showStackImgs() {
        var num = $('#dim-3 span').text(),
            dbl = $('#field_1_46 input:checked').val(),
    ...
    function toggleJambState() {
        ...
        $('#field_1_48 input').removeClass('jamb-hold');
    ...
    function doubleGateChanges() {
        var jambInput = $('#field_1_48 input');

        doubleGateTrue = $('#choice_1_46_0').is(':checked');
    ...
    function limitSet() {
        var width = $('#input_1_13'),
            height = $('#input_1_14'),
            pocket = $('#input_1_26'),
            combinedWidth = $('#input_1_51'),
            quant = $('#input_1_24'),
