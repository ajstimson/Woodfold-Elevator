(function ($) {
    $(window).load(function () {     
        ...
        */
        ...
        var inputs = $('#input_1_56, #input_1_66,#input_1_67,#input_1_68');
        var labels = $('#field_1_66 > label,#field_1_67 > label,#field_1_68 > label');

        document.addEventListener('click', function (event) {

            if (!event.target.matches('#choice_1_74_1')) return;
    ...
    function fillAccountInfo(){
        ...
        if( data.length > 0 ){
            ...
            $('#input_1_1').val(arr.user_company).addClass('rendered');
            $('#input_1_60').val(arr.user_first).addClass('rendered');
            $('#input_1_61').val(arr.user_last).addClass('rendered');
            $('#input_1_6').val(arr.user_email).addClass('rendered');
            $('#input_1_76').val(arr.user_phone).addClass('rendered');
            $('#input_1_77').val(arr.user_extension).addClass('rendered');
            $('#input_1_79').val(arr.user_street_address).addClass('rendered');
            $('#input_1_80').val(arr.user_street_address_2).addClass('rendered');
            $('#input_1_81').val(arr.user_city).addClass('rendered');
            $('#input_1_82').val(arr.user_state).addClass('rendered');
            $('#input_1_83').val(arr.user_zip).addClass('rendered');
            $('#input_1_84').val(arr.user_country).addClass('rendered');
    ...
    function renderFocus(){
        $('.rendered').addClass('active-input has-val').parent().parent().addClass('verified');
    ...
    function setSubdivision(inputs,labels){
        ...
        if(value === 'US'){
            ...
            $('#input_1_66').show().prop( "disabled", false );
        ...
        if(value === 'USO'){
            ...
            $('#input_1_67').show().prop( "disabled", false );
        ...
        if(value === 'CA'){
            ...
            $('#input_1_68').show().prop( "disabled", false );
    ...
    function usoList(){
        var arr = {
            AA:"",AS:"American Samoa",FM:"Federated States of Micronesia",GU:"Guam",MH:"Marshall Islands",MP:"Northern Mariana Islands",PR:"Puerto Rico",PW:"Palau",VI:"U.S. Virgin Islands",UM:"U.S. Minor Outlying Islands"
        };
     ...
     function provinceList(){
        var arr = {
            AA:"",NL:"Newfoundland and Labrador",PE:"Prince Edward Island",NS:"Nova Scotia",NB:"New Brunswick",QC:"Quebec",ON:"Ontario",MB:"Manitoba",SK:"Saskatchewan",AB:"Alberta",BC:"British Columbia",YT:"Yukon",NT:"Northwest",NU:"Nunavut"
        };
        return arr;
    }
